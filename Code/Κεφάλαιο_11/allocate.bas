'' This program uses the ALLOCATE(...) function
'' to create a buffer of 15 integers that is
'' then filled with the first 15 numbers 
'' of the Fibonacci Sequence, then output to the
'' screen. 
'' Note the call to DEALLOCATE(...)
